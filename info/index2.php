      ...
      <h1>Bootstrap＆PHP</h1>  
        <div class="row">
            ...
            <div class="form-group">
                <label for="name" class="col-sm-2 col-lg-3 control-label">お名前</label>
                <div class="col-sm-10 col-lg-9">
                  <input name="name" id="name" type="text" size="50" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label for="gender" class="col-sm-2 col-lg-3 control-label">性別</label>
                <div class="col-sm-10 col-lg-9">
            ...
            <div class="form-group">
                <label for="blood" class="col-sm-2 col-lg-3 control-label">血液型</label>
                <div class="col-sm-10 col-lg-9">
            ...
            <div class="form-group">
                <label for="yubin" class="col-sm-2 col-lg-3 control-label">郵便番号</label>
                <div class="col-sm-10 col-lg-9">
                    <input name="yubin" id="yubin" type="text" size="50" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label for="mail" class="col-sm-2 col-lg-3 control-label">メールアドレス</label>
                <div class="col-sm-10 col-lg-9">
                  <input name="mail" id="mail" type="text" size="50" maxlength="255" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label for="sub" class="col-sm-2 col-lg-3 control-label">件名</label>
                <div class="col-sm-10 col-lg-9">
                    <input name="sub" id="sub" type="text" size="50" maxlength="255" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label for="naiyou" class="col-sm-2 col-lg-3 control-label">お問い合わせ内容</label>
                <div class="col-sm-10 col-lg-9">
