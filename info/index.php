      ...
      <h1>Bootstrap＆PHP</h1>  
        <div class="row">
            ...
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">お名前</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">血液型</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input name="yubin" id="yubin" type="text" size="50" />
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">メールアドレス</label>
                <div class="col-sm-10">
                  <input name="mail" id="mail" type="text" size="50" maxlength="255" />
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">件名</label>
                <div class="col-sm-10">
                    <input name="sub" id="sub" type="text" size="50" maxlength="255" />
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-2 control-label">お問い合わせ内容</label>
                <div class="col-sm-10">
